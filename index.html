...
<body>
	...
	<div class="container">
		...
		<section class="education">	
			<h2>B.A. Economics With Honors <br/> Washington University in St. Louis</h2>
		</section>
		...
		<section class="experience">
			<div class="row">
				<div class="grid-2">
					<h2>Founder Codemy.com</h2>
					<p>2014 - 2016</p>
				</div>
				<div class="grid-4">
					<ul>
						<li>Built an Awesome Website</li>
						<li>Created a bunch of online learning courses teaching people to code!</li>
						<li>Signed up 10,000 Students!</li>
					</ul>
				</div>
			</div>
			<div class="row">
		...
		<footer class="center">
			<hr>
			<span>Copyright &copy; John Elder - All Rights Reserved</span>
		</footer>
